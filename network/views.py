...
class NetworkNodeViewSet(viewsets.ModelViewSet):
    ...
    def statistics(self, request):
        ...
        total_debt = (
            NetworkNode.objects.aggregate(total_debt=Sum("debt"))["total_debt"] or 0
        )
    ...
    def remove_product(self, request, pk=None):
        ...
        try:
            ...
            node_product = NetworkNodeProduct.objects.get(
                network_node=node, product=product
            )
            node_product.delete()
...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    def assign_to_node(self, request, pk=None):
        ...
        try:
            ...
            return Response(
                {"error": "Узел сети не найден"}, status=status.HTTP_404_NOT_FOUND
            )
    ...
    def in_network(self, request):
        ...
        products = Product.objects.prefetch_related(
            "networknodeproduct_set__network_node"
        ).all()
...
class NetworkNodeProductViewSet(viewsets.ModelViewSet):
    ...
    queryset = NetworkNodeProduct.objects.select_related(
        "network_node", "product"
    ).all()
...
class HomeView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            cities_queryset = (
                NetworkNode.objects.filter(city__isnull=False)
                .exclude(city__exact="")

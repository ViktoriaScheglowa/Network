...
router.register(
    r"node-products", views.NetworkNodeProductViewSet, basename="node-product"
)
...
urlpatterns = [
    ...
    path(
        "network-nodes/<int:pk>/clear-debt/",

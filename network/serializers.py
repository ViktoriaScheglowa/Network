...
class NetworkNodeProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'quantity', 'is_available', 'added_at'
        ]
...
class NetworkNodeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'debt', 'created_at', 'is_active', 'hierarchy_level',
            'products_info'
        ]
    ...
    def validate_products(self, value):
        ...
        for product_data in value:
            if 'product_id' not in product_data:
                raise serializers.ValidationError("Каждый продукт должен иметь product_id")
        return value